...
silent only
cd ~/Projects/binary-tree
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/BinaryTree.cpp
badd +1 Makefile
badd +0 test/tree_test.cpp
badd +22 src/BinaryTree.h
badd +1 ~/Projects/queues/test/queue_test.cpp
badd +1 ~/Projects/sparse-array/test/array_test.cpp
badd +3 ~/Projects/sparse-array/src/TwoDArray.h
badd +2 src/Node.h
args src/BinaryTree.cpp
edit test/tree_test.cpp
...
exe '3resize ' . ((&lines * 12 + 26) / 52)
exe 'vert 3resize ' . ((&columns * 70 + 71) / 142)
exe '4resize ' . ((&lines * 37 + 26) / 52)
...
silent! normal! zE
let s:l = 159 - ((21 * winheight(0) + 12) / 25)
...
6
normal! 025l
lcd ~/Projects/binary-tree
wincmd w
argglobal
edit ~/Projects/binary-tree/src/BinaryTree.h
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <RightMouse> <Plug>delimitMateMRightMouse
imap <buffer> <LeftMouse> <Plug>delimitMateMLeftMouse
...
wincmd w
argglobal
edit ~/Projects/binary-tree/src/BinaryTree.cpp
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <RightMouse> <Plug>delimitMateMRightMouse
imap <buffer> <LeftMouse> <Plug>delimitMateMLeftMouse
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((15 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
